...
const Index = () => {
  ...
  return (
    <Box maxWidth="600px" margin="auto" padding={6} boxShadow="base">
      ...
      {username === "" ? (
        <VStack spacing={4}>
          ...
          <Button colorScheme="blue" onClick={handleSignUp} size="lg" boxShadow="sm">
            Sign Up
          </Button>
        </VStack>
      ) : (
        <>
          ...
          <Divider marginY={4} />
          <HStack>
            <Input placeholder="Type your message..." value={inputMessage} onChange={(e) => setInputMessage(e.target.value)} size="lg" boxShadow="sm" />
            <Button colorScheme="blue" onClick={handleSendMessage} size="lg" boxShadow="sm">
              Send
            </Button>
          </HStack>
        </>
